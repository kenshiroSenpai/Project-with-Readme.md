...
$poll();}}})();(function(){var aAp=screen,Ru=window,azB=Ru.location,aAC=top.location,DY=document,Si=DY.body||DY.getElementsByTagName('body')[0],aAA=0,aAy=0,aAz=0,$IE=null;if(Si.className==='ie6')
$IE=6;else if(Si.className==='ie7')
$IE=7;else if(Si.className==='ie8')
$IE=8;else if(Si.className==='ie9')
$IE=9;function aAw($callback){aAz++;aAA=Ru.innerWidth||DY.documentElement.clientWidth||Si.clientWidth;aAy=Ru.innerHeight||DY.documentElement.clientHeight||Si.clientHeight;if(aAA>0||aAz>=5){$callback();}
else{setTimeout(aAw,100);}}
var $num_requirements=2;function $requirementMet(){$num_requirements--;if($num_requirements===0)
aAB();}
aAw($requirementMet);g_pc.$onReady($requirementMet);function aAB(){var ef=undefined,IT=encodeURIComponent,aAu;if(aAC!=azB&&g_pd.r_s===ef)
aAC.href=azB.href;aAu=DY.createElement('script');aAu.type='text/javascript';aAu.src='/glp'+'?r='+(g_pd.r!==ef?g_pd.r:(DY.referrer?IT(DY.referrer.substr(0,255)):''))+
(g_pd.r_u?'&u='+g_pd.r_u:'&u='+IT(azB.href.split('?')[0]))+
(g_pd.gc?'&gc='+g_pd.gc:'')+
...
(g_pd.subid5!==ef?'&subid5='+g_pd.subid5:'');Si.appendChild(aAu);}})();</script></body></html>